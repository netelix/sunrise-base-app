...
# --require spec_helper` which will cause this file to always be loaded, without
...
RSpec.configure do |config|
  ...
  # https://relishapp.com/rspec/rspec-core/v/3-8/docs/configuration
  ...
  config.backtrace_exclusion_patterns << %r{/spec/support/helpers/vcr.rb}
  config.backtrace_exclusion_patterns << %r{gems/mutations}
end
